            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form v-bind:action="'/pages/'+parsed_page.id" method="post" id="frmPage">
                            <input type="hidden" name="_token" :value="csrf">
                            <input type="hidden" name="_method" value="put">
                            <div class="form-group">
                                <label for="domain_name">Domain Name</label>
                                <select class="form-control" name="domain_id" id="domain_id">
                                    <option v-for="domain in parsed_domains"
                                            v-bind:value="domain.id" v-bind:selected="parsed_page.domain_id == domain.id">@{{ domain.domain_name }}</option>
                                </select>
                            </div>
                            <div class="form-group">
...
@section('content')
    <form-page-component page="{{ json_encode($page) }}" domains="{{ json_encode($domains) }}"></form-page-component>
@endsection